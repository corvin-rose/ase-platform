...
describe('ShaderViewerComponent', () => {
  ...
  function prepareAuthStatus(status: boolean): void {
    ...
    let mockShaderService: jasmine.SpyObj<ShaderService> = jasmine.createSpyObj('ShaderService', [
      'getShaderById',
    ]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        ...
        status ? { provide: ShaderService, useValue: mockShaderService } : ShaderService,
        {
